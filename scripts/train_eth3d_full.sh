...
CHECKPOINT_DIR="/${MOUNT_DIR}/eth3d_outputs_multinerf_full"
...
python -m train --gin_configs=configs/eth3d.gin \
                ...
                --gin_bindings="Config.full_training = True" \
...
scp -r ${CHECKPOINT_DIR}/${scene}/${scene}.zip jyl:/mnt/data1/cluster_results/multinerf_full/
